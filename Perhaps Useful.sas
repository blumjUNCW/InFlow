...
data flows;
  ...
  %do j=1 %to &days;/**this sets up an iterative do loop on the macro variable j**/
...
run;
%mend;
options mprint;/**the MPRINT option shows all code generated by the macro as the SAS language processor sees it**/
%createAvg(14);
